...
This repository is the server (back-end) for my Campus Management Project submission.

Group Members: Just me (Ataur Muhith)

----------
### To set up and run the server (back-end) application on your local machine:
